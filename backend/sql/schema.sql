...
CREATE TABLE Cartoes_rfid (
    ...
    status_cartao_rfid VARCHAR(20) CHECK (status_cartao_rfid IN ("em_uso", "estoque", "bloqueado")),
    criado_em DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE Sessoes (
    ...
    sessao_status VARCHAR (30) CHECK(sessao_status IN ("carregando", "encerrada", "cancelada", "pagamento_pendente", "paga")),
